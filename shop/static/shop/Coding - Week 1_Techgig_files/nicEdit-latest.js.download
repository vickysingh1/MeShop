 ...
 */
//var nicURI_given = "http://10.150.200.57/jais/nicEdit/nicUpload.php";
var nicURI_given = base_url + "/nicUpload.php";
...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: base_url + '/nicEditIcons-latest.gif',
...
var nicUploadButton = nicEditorAdvancedButton.extend({
    ...
    addForm: function() {
        ...
        if (this.uri == this.nicURI) {
            A.write('<div style="position: absolute; margin-left: 160px;"></div>')
        }
